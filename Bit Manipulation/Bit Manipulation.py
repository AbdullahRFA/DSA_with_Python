...
class Solution:
    def bitManipulation(self, num, i):
        ...
        # Print in the exact required format: three space-separated values
        print(f"{ithBit} {setBit} {clearBit}")  # no trailing space, no extra newline